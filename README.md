...
기본 세계지도의 저배율은 Natural Earth 기반이다. 승인된 모나코 건물·뉴욕시 5개 카운티 도로 지역 패키지도 고배율에서 연다. 나주 자체 GeoDB 시안은 S16 `NO_GO` 상태이므로 `canonical-proof`를 명시해야 연다.

...
| 미국 | Census 2025의 **22개 주·DC, 1,255개 카운티 상당 원천 단위**를 실증. [세계 지도 범위 표](WORLD_MAP.md)와 각 주의 검증 기록에 채택·제외·타일 수를 남겼다. 최근 [루이지애나주 64개 교구 도로](LA_STATE_PROGRESS.md)의 원본 262,800행 계보와 106,313개 타일을 감사했다. 다른 주 카운티는 미수집·미검증. 공식 배포 단위는 카운티 상당 단위 All Roads 파일. |

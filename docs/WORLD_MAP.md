...
상세 원천 확대는 [모나코·Queens 건물](WORLD_BUILDINGS_PROGRESS.md), [뉴욕주 62개 카운티 도로](NY_STATE_ROADS_PROGRESS.md), [뉴저지주 21개 카운티 도로](NJ_STATE_ROADS_PROGRESS.md), [델라웨어주 3개 카운티 도로](DE_STATE_ROADS_PROGRESS.md), [코네티컷주 9개 계획지역 도로](CT_STATE_ROADS_PROGRESS.md), [로드아일랜드주 5개 카운티 도로](RI_STATE_ROADS_PROGRESS.md), [매사추세츠주 14개 카운티 도로](MA_STATE_ROADS_PROGRESS.md)·[수면](MA_STATE_WATER_PROGRESS.md), [뉴햄프셔주 10개 카운티 도로·수면](NH_STATE_PROGRESS.md), [버몬트주 14개 카운티 도로·수면](VT_STATE_PROGRESS.md), [메인주 16개 카운티 도로·수면](ME_STATE_PROGRESS.md), [메릴랜드주 24개 카운티 상당 단위 도로·수면](MD_STATE_PROGRESS.md), [펜실베이니아주 67개 카운티 도로·수면](PA_STATE_PROGRESS.md), [웨스트버지니아주 55개 카운티 도로·수면](WV_STATE_PROGRESS.md), [오하이오주 88개 카운티 도로·수면](OH_STATE_PROGRESS.md), [버지니아주 133개 카운티 상당 단위 도로·수면](VA_STATE_PROGRESS.md), [노스캐롤라이나주 100개 카운티 도로·수면](NC_STATE_PROGRESS.md), [사우스캐롤라이나주 46개 카운티 도로·수면](SC_STATE_PROGRESS.md), [테네시주 95개 카운티 도로·수면](TN_STATE_PROGRESS.md), [켄터키주 120개 카운티 도로·수면](KY_STATE_PROGRESS.md), [조지아주 159개 카운티 도로·수면](GA_STATE_PROGRESS.md), [앨라배마주 67개 카운티 도로·수역](AL_STATE_PROGRESS.md), [미시시피주 82개 카운티 도로·수역](MS_STATE_PROGRESS.md), [루이지애나주 64개 교구 도로·수역](LA_STATE_PROGRESS.md), [아칸소주 75개 카운티 도로·수역](AR_STATE_PROGRESS.md), [플로리다주 67개 카운티 도로·수역](FL_STATE_PROGRESS.md), [워싱턴 DC 도로·수면](DC_PROGRESS.md), [프랑스 IGN 파리 도로](FR_PARIS_ROADS_PROGRESS.md)·[수면](FR_PARIS_WATER_PROGRESS.md)·[여객역](FR_PARIS_STATIONS_PROGRESS.md), [GB 공식 RoadLink 52개 격자](GB_ROADS_PROGRESS.md), [캐나다 13개 지역 NRN 도로](CA_ROADS_PROGRESS.md), [서호주 공식 도로 9개 관리 지역](AU_WA_ROADS_PROGRESS.md), [빅토리아 DTP 관리 도로](AU_VIC_DTP_ROADS_PROGRESS.md), [퀸즐랜드 79개 지역 QRT 도로](AU_QLD_QRT_ROADS_PROGRESS.md), [뉴욕시 5개 카운티 수면](WORLD_WATER_PROGRESS.md), [뉴욕시 주변 공원 경계](WORLD_PARKS_PROGRESS.md)에 실증했다. 기본 세계 모드는 기존 79개, GB 52개, 캐나다 15개, 서호주 9개, 빅토리아 DTP 1개, 퀸즐랜드 QRT 79개, 총 235개 지역 패키지를 필요할 때 결합한다. 이 지역 밖의 상세 지리는 구축되지 않았다.
사용자가 선택한 기존 공유조건 금지 규칙에 따라 도로는 국가별 공식 원천으로 진행한다. 미국 뉴욕주·뉴저지주·델라웨어주·코네티컷주·로드아일랜드주·매사추세츠주·뉴햄프셔주·버몬트주·메인주·메릴랜드주·펜실베이니아주·웨스트버지니아주·오하이오주·버지니아주·노스캐롤라이나주·사우스캐롤라이나주·테네시주·켄터키주·조지아주·앨라배마주·미시시피주·루이지애나주·아칸소주·플로리다주·워싱턴 DC 1,397개 카운티 상당 단위, 프랑스 IGN 파리 원천 범위, Great Britain의 OS Open Roads RoadLink, 캐나다 13개 지역의 NRN Road Segment 및 서호주 Main Roads Road Network, 빅토리아 DTP 관리 도로와 퀸즐랜드 QRT의 일반 차량 도로 원천을 처리했으며 세계 상세 도로망은 아직 없다.
...
| z10–z15 | 버지니아주 133개 카운티 상당 단위 원천 범위 | Census 2025 도로 4개·수면 1개 지역 PMTiles | 주 경계 연결성·독립 위치 정확도 미검증 |
| z10–z15 | 노스캐롤라이나주 100개 카운티 원천 범위 | Census 2025 도로 4개·수면 1개 지역 PMTiles | 해양면 고배율 미구축; 주 경계 연결성·독립 위치 정확도 미검증 |
| z10–z15 | 사우스캐롤라이나주 46개 카운티 원천 범위 | Census 2025 도로 2개·수면 1개 지역 PMTiles | 주 경계 연결성·독립 위치 정확도 미검증 |
| z10–z15 | 테네시주 95개 카운티 원천 범위 | Census 2025 도로 2개·수면 1개 지역 PMTiles | 주 경계 연결성·독립 위치 정확도 미검증 |
| z10–z15 | 켄터키주 120개 카운티 원천 범위 | Census 2025 도로 3개·수면 2개 지역 PMTiles | 주 경계 연결성·독립 위치 정확도 미검증 |
| z10–z15 | 조지아주 159개 카운티 원천 범위 | Census 2025 도로 4개·수면 1개 지역 PMTiles | 타일 내부 도로 경계 미일치 0; 꼭짓점 7건 모호·주 경계 연결성·독립 위치 정확도 미검증 |
| z10–z15 | 앨라배마주 67개 카운티 원천 범위 | Census 2025 도로 2개·수역 1개 지역 PMTiles | 타일 내부 도로 경계 미일치 0; 꼭짓점 5건 모호·주 경계 연결성·독립 위치 정확도 미검증 |
| z10–z15 | 미시시피주 82개 카운티 원천 범위 | Census 2025 도로 2개·수역 1개 지역 PMTiles | 타일 내부 도로 경계 미일치 0; 꼭짓점 6건 모호·주 경계 연결성·독립 위치 정확도 미검증 |
| z10–z15 | 루이지애나주 64개 교구 원천 범위 | Census 2025 도로 2개·수역 1개 지역 PMTiles | 타일 내부 도로 경계 미일치 0; 꼭짓점 1건 모호·주 경계 연결성·독립 위치 정확도 미검증 |
| z10–z15 | 아칸소주 75개 카운티 원천 범위 | Census 2025 도로 2개·수역 1개 지역 PMTiles | 확정 가능한 타일 내부 미일치 0; 꼭짓점 11건·정수화 1건 모호, 주 경계 연결성·독립 위치 정확도 미검증 |
| z10–z15 | 플로리다주 67개 카운티 원천 범위 | Census 2025 도로 4개·수역 3개 지역 PMTiles | 확정 가능한 타일 내부 미일치 0; 꼭짓점 7건·정수화 1건 모호, 주 경계 연결성·독립 위치 정확도 미검증 |
...
| z10–z15 | 서호주 공식 Road Network 원천 범위 | WA 관리 지역별 도로 PMTiles 9개 | 원본은 도로 번호가 부여된 주·지방정부 도로 중심. 도로 완전성·독립 위치 정확도·관리 지역 간 연결성 미검증 |
| z10–z15 | 빅토리아 DTP 관리 도로 원천 범위 | DTP Managed Roads 지역 PMTiles 1개 | 주 전체 Vicmap 도로망이 아님. 지방정부 도로·독립 위치 정확도·연결성 미검증 |
| z10–z15 | 퀸즐랜드 QRT 원천 79개 지역 | 공식 Roads and Tracks에서 현재 운영 중인 일반 차량 도로 지역 PMTiles 79개 | 트랙·접근 제한 도로·보행·자전거로 별도; 독립 위치 정확도·지역 경계 연결성 미검증 |
...
### 버지니아주 도로·수면 확장 — 2026-09-25

[Census 공식 ZIP 266개 감사](VA_STATE_PROGRESS.md)에서 도로 447,095개와 수면 55,296개를 채택하고 각각 174,425개·30개를 제외했다. Rust가 공식 디렉터리의 도로·수면 133개 카운티 상당 단위 목록 일치를 확인했다. 도로 원본의 실제 타일 135,199개를 압축 바이트 동일한 네 팩으로 나누고 최종 팩과 수면 80,358개 타일을 전수 해독해 실패 0개였다. 기본 세계 모드 [Roanoke](../artifacts/world-roads/va-state/roanoke-road-water-z14.png), [Charlottesville](../artifacts/world-roads/va-state/charlottesville-road-water-z14.png), [Richmond](../artifacts/world-roads/va-state/richmond-road-water-z14.png), [Norfolk](../artifacts/world-roads/va-state/norfolk-road-water-z14.png) z14 도로·수면 화면도 각각 타일 실패 0개였다. 독립 위치 정확도와 경계 연결성은 미검증이다.

### 노스캐롤라이나주 도로·수면 확장 — 2026-09-25

[Census 공식 ZIP 200개 감사](NC_STATE_PROGRESS.md)에서 도로 460,586개와 수면 41,148개를 채택하고 각각 49,525개·20개를 제외했다. 공식 도로·수면 목록의 100개 카운티 번호가 일치하며 도로 원본 510,111행 전체의 채택·제외 계보가 맞는다. 도로 원본 152,590개 실제 타일을 압축 바이트 동일한 네 팩으로 나누고, 네 팩과 수면 70,852개 타일을 모두 해독해 실패 0개였다. [Asheville](../artifacts/world-roads/nc-state/asheville-road-water-z14.png), [Charlotte](../artifacts/world-roads/nc-state/charlotte-road-water-z14.png), [Raleigh](../artifacts/world-roads/nc-state/raleigh-road-water-z14.png), [Wilmington](../artifacts/world-roads/nc-state/wilmington-road-water-z14.png) z14 화면의 타일 실패도 각각 0개다. 해양면 고배율, 독립 위치 정확도, 경계 연결성은 미검증·미완료다.

VA–NC 경계의 공통 타일 777개에서 동일 좌표열 도로 108개를 관측해 합성 시 정확히 같은 선을 한 번만 그리도록 했다. [경계 z11 화면](../artifacts/world-roads/nc-state/va-nc-border-world-z11.png) 타일 실패는 0이었다. 부분 중첩·실제 연결성은 이 검사로 판정하지 않는다.

### 사우스캐롤라이나주 도로·수면 확장 — 2026-09-25

[Census 공식 ZIP 92개 감사](SC_STATE_PROGRESS.md)에서 도로 265,485개와 수면 14,875개를 채택하고 각각 18,802개·8개를 제외했다. 공식 도로·수면 목록의 46개 카운티 번호가 일치하며 도로 원본 284,287행 전체의 채택·제외 계보가 맞는다. 도로 원본 93,006개 실제 타일을 압축 바이트 동일한 두 팩으로 나누고, 두 팩과 수면 38,194개 타일을 모두 해독해 실패 0개였다. [Greenville](../artifacts/world-roads/sc-state/greenville-road-water-z14.png), [Charleston](../artifacts/world-roads/sc-state/charleston-road-water-z14.png), [NC–SC 경계](../artifacts/world-roads/sc-state/nc-sc-border-world-z11.png) 화면의 타일 실패도 각각 0개다. 경계 공통 타일 848개에서 정확히 동일한 도로 좌표열 427개를 관측했고 합성 단계의 중복 표시 제거가 적용된다. 부분 중첩·연결성과 독립 위치 정확도는 아직 검증하지 않았다.

### 테네시주 도로·수면 확장 — 2026-09-25

[Census 공식 ZIP 190개 감사](TN_STATE_PROGRESS.md)에서 도로 307,068개와 수면 3,831개를 채택하고 각각 37,434개·5개를 제외했다. 공식 도로·수면 목록의 95개 카운티 번호가 일치하며 원본 도로 344,502행 전체의 계보가 맞는다. 도로 원본 131,851개 실제 타일을 압축 바이트 동일한 두 팩으로 나누고, 두 팩과 수면 21,899개 타일을 모두 해독해 실패 0개였다. [Memphis](../artifacts/world-roads/tn-state/memphis-road-water-z14.png), [Nashville](../artifacts/world-roads/tn-state/nashville-road-water-z14.png), [Knoxville](../artifacts/world-roads/tn-state/knoxville-road-water-z14.png), [NC–TN](../artifacts/world-roads/tn-state/nc-tn-border-world-z11.png) 및 [VA–TN](../artifacts/world-roads/tn-state/va-tn-border-world-z11.png) 경계 화면의 타일 실패도 0개다. NC 경계에는 동일 좌표열 도로 91개, VA 경계에는 95개가 관측됐다. 부분 중복·실제 연결성과 독립 위치 정확도는 아직 검증하지 않았다.

### 켄터키주 도로·수면 확장 — 2026-09-25

[Census 공식 ZIP 240개 감사](KY_STATE_PROGRESS.md)에서 도로 233,240개와 수면 185,649개를 채택하고 각각 28,330개·16개를 제외했다. 공식 도로·수면 목록의 120개 카운티 번호가 일치하며 원본 도로 261,570행 전체의 계보가 맞는다. 도로 원본 131,626개 실제 타일을 압축 바이트 동일한 세 팩으로, 수면 원본 109,195개 타일을 두 팩으로 나눴다. 원본·최종 팩 전체 해독 실패는 0개였다. [Paducah](../artifacts/world-roads/ky-state/paducah-road-water-z14.png), [Louisville](../artifacts/world-roads/ky-state/louisville-road-water-z14.png), [Pikeville](../artifacts/world-roads/ky-state/pikeville-road-water-z14.png), [TN–KY 경계](../artifacts/world-roads/ky-state/tn-ky-border-world-z11.png) 화면의 타일 실패도 0개다. TN·VA·WV·OH 경계 공통 타일의 동일 좌표열 도로 수는 각각 653개·97개·4개·0개다. 부분 중복·실제 연결성과 독립 위치 정확도는 아직 검증하지 않았다.

### 조지아주 도로·수역 확장 — 2026-09-25

[Census 공식 ZIP 318개 감사](GA_STATE_PROGRESS.md)에서 도로 412,918개와 수역 88,722개를 채택하고 각각 28,011개·35개를 제외했다. 공식 도로·수역 목록의 159개 카운티 번호가 일치하며 원본 도로 440,929행 전체의 계보가 맞는다. 도로 원본 172,941개 실제 타일을 압축 바이트 동일한 네 팩으로 나눴고, 최종 도로·수역 99,703개 타일의 해독 실패는 0개였다. 버퍼 경계 교차점을 명시하는 Rust 빌더 개선 후 타일 내부 도로 경계 미일치는 0개, 네 타일 꼭짓점 주변 모호 사례는 7개로 별도 보고한다. [Atlanta](../artifacts/world-roads/ga-state/atlanta-road-water-z14.png)·[Savannah](../artifacts/world-roads/ga-state/savannah-road-water-z14.png)·[Augusta](../artifacts/world-roads/ga-state/augusta-road-water-z14.png)와 [NC–GA 경계](../artifacts/world-roads/ga-state/nc-ga-border-world-z11.png) 화면의 타일 실패도 0개다. SC·NC·TN 공통 타일의 동일 좌표열 도로는 각각 0개·4개·56개였다. 주 경계 실제 연결성·부분 중복·독립 위치 정확도는 아직 미검증이다.

### 앨라배마주 도로·수역 확장 — 2026-09-25

[Census 공식 ZIP 134개 감사](AL_STATE_PROGRESS.md)에서 도로 310,125개와 수역 53,047개를 채택하고 각각 28,398개·14개를 제외했다. 도로 원본 144,241개 타일을 바이트 동일한 두 팩으로 분할했고 도로·수역 최종 팩을 전수 해독해 실패 0개였다. 타일 내부 도로 경계 미일치는 0개이며 꼭짓점 근처 5건은 모호하다. Birmingham·Montgomery·Mobile과 AL–GA 경계 화면의 타일 실패는 0개다. 주 경계 실제 연결성과 독립 위치 정확도는 미검증이다.

### 미시시피주 도로·수역 확장 — 2026-09-25

[Census 공식 ZIP 164개 감사](MS_STATE_PROGRESS.md)에서 도로 240,758개와 수역 20,770개를 채택하고 각각 34,260개·8개를 제외했다. 도로 원본 136,057개 타일을 바이트 동일한 두 팩으로 분할했고 도로·수역 최종 팩을 전수 해독해 실패 0개였다. 타일 내부 도로 경계 미일치는 0개이며 꼭짓점 근처 6건은 모호하다. Jackson·Gulfport·Tupelo와 MS–AL 경계 화면의 타일 실패는 0개다. 주 경계 실제 연결성과 독립 위치 정확도는 미검증이다.

### 루이지애나주 도로·수역 확장 — 2026-09-25

[Census 공식 ZIP 128개 감사](LA_STATE_PROGRESS.md)에서 도로 242,570개와 수역 51,929개를 채택하고 각각 20,230개·82개를 제외했다. 도로 원본 106,313개 타일을 바이트 동일한 두 팩으로 분할했고 도로·수역 최종 팩을 전수 해독해 실패 0개였다. 타일 내부 도로 경계 미일치는 0개이며 꼭짓점 근처 1건은 모호하다. Baton Rouge·New Orleans·Lafayette와 LA–MS 경계 화면의 타일 실패는 0개다. 주 경계 실제 연결성과 독립 위치 정확도는 미검증이다.

### 아칸소주 도로·수역 확장 — 2026-09-25

[Census 공식 ZIP 150개 감사](AR_STATE_PROGRESS.md)에서 도로 254,273개와 수역 57,664개를 채택하고 각각 30,811개·5개를 제외했다. 도로 원본 156,168개 타일을 바이트 동일한 두 팩으로 분할했고 도로·수역 최종 팩을 전수 해독해 실패 0개였다. 확정 가능한 타일 내부 도로 경계 미일치는 0개이며 꼭짓점 근처 11건·정수화 추정 1건은 별도로 모호하다. Little Rock·Fayetteville·Jonesboro와 AR–LA 경계 화면의 타일 실패는 0개다. 주 경계 실제 연결성과 독립 위치 정확도는 미검증이다.

### 플로리다주 도로·수역 확장 — 2026-09-25

[Census 공식 ZIP 134개 감사](FL_STATE_PROGRESS.md)에서 도로 647,644개와 수역 93,646개를 채택하고 각각 37,152개·54개를 제외했다. 도로 원본 132,265개 타일을 네 팩으로, 수역 원본 114,110개 타일을 세 팩으로 압축 바이트 동일하게 분할했고 모든 최종 팩의 해독 실패는 0개였다. 확정 가능한 타일 내부 도로 경계 미일치는 0개이며 꼭짓점 근처 7건·정수화 추정 1건은 모호하다. Miami·Orlando·Tampa·Jacksonville과 GA–FL 경계 화면의 타일 실패는 0개다. 주 경계 실제 연결성과 독립 위치 정확도는 미검증이다.

### 서호주 공식 도로 확장 — 2026-09-25

[Main Roads WA의 공개 Road Network](AU_WA_ROADS_PROGRESS.md)에서 189,888개 원본 선형을 검사해 차량 도로 188,864개를 채택하고 보행 경로·계획 도로·교차 연결선 1,024개를 분리했다. 원본 관리 지역에서 파생한 9개 팩의 253,612개 타일을 해독했고, 확정 가능한 같은 팩 내부 도로 경계 불일치는 0건, 꼭짓점 모호 사례는 1건이었다. [Perth z14](../artifacts/world-roads/au-wa/perth-world-z14.png) 기본 세계 화면의 타일 오류는 0개다. 모든 실제 도로·현장 위치 정확도·관리 지역 사이 연결성은 미검증이다.

### 빅토리아 DTP 관리 도로 실증 — 2026-09-25

[Transport Victoria의 CC BY 4.0 GeoJSON](AU_VIC_DTP_ROADS_PROGRESS.md)에서 90,797개 선형을 검사해 90,607개를 채택했다. 코드 뜻을 공식 범례로 확인하지 못한 `NR`·`PR` 190개는 별도 거절 기록에 남겼다. 47,604개 타일 전수 해독의 확정 가능한 내부 도로 경계 불일치는 0건, 꼭짓점 모호 1건이다. [Melbourne z14](../artifacts/world-roads/au-vic-dtp/melbourne-world-z14.png)의 타일 오류는 0개였다. 이는 DTP 관리 도로만의 실증이며 빅토리아주 전체 도로망이 아니다.

### 퀸즐랜드 QRT 차량 도로 실증 — 2026-09-25

[공식 Roads and Tracks 스냅샷](AU_QLD_QRT_ROADS_PROGRESS.md)의 선형 562,728개 중 현재 운영 중인 일반 차량 도로 411,847개를 채택하고 150,881개를 사유별로 분리했다. 원본 79개 지역에서 만든 PMTiles 79개의 실제 타일 303,681개를 전수 해독했고 팩 내부 확정 경계 불일치는 0건이었다. 세계 모드의 235개 팩 타일 읽기 테스트는 통과했다. Mac 잠금으로 Metal 화면 캡처는 아직 성공하지 못했고, 트랙·접근 제한 도로와 수면·건물의 퀸즐랜드 상세 레이어, 지역 간 연결성, 독립 위치 정확도는 미검증이다.
...
현재 목록은 파일 156개의 manifest를 시작 시 검증하고, PMTiles는 각 파일이 처음 필요할 때 연다. manifest 범위를 z5 공간 셀에 등록해 카메라·타일의 셀에 걸친 패키지만 검사하고, 실제 타일과 원천 범위의 교차를 다시 확인한다. 열린 PMTiles는 최근 사용 순서로 최대 16개를 유지하며 축출된 파일은 필요하면 다시 연다. 코드 테스트에서 매니저 생성 직후 열린 지역 PMTiles 수는 0이고, 최근 사용 파일을 제외한 축출 결과가 확인됐다. 인덱스·파일 상한 적용 전후 모나코 동기·Queens 비동기 Metal PNG는 각각 바이트 단위로 같았고 두 캡처 모두 실패 0이었다. 이 성능 검증은 당시 파일 2개에 대한 것이다. 이후 5개 파일의 세계 모드 테스트와 당시 6개 파일의 지역 목록 로드 검사, [Queens 도로·건물·수면·공원](../artifacts/world-integration/queens-four-layers-world.png) Metal 캡처에서 타일 실패 0을 확인했다. 현재 127개 목록은 로드 테스트와 GB 네 지역·캐나다 13개 지역·Delaware·Connecticut·Rhode Island·Massachusetts·New Hampshire·Vermont·Maine·Maryland·DC·Pennsylvania·West Virginia·Ohio·Virginia·North Carolina·South Carolina·Tennessee·Kentucky·Georgia·Paris 화면 캡처까지 검증했지만 iPhone 성능·갱신은 아직 측정되지 않았다.
...
이 감사는 파일 해독과 표시 확인이다. 실제 현장 정확도, 도로·수계 완전성, 국가별 건물 커버리지의 독립 검증은 아니다. 원본 선이 없는 지역을 새 선으로 채우지 않는다. 기존 50m와 동아시아 10m 파일은 비교·회귀용으로 보관한다. 기본 세계 모드는 세계 110m·10m 파일을 열고 기존 79개·GB 52개·캐나다 15개·서호주 9개·빅토리아 DTP 1개·퀸즐랜드 QRT 79개, 총 235개 승인 지역 PMTiles를 필요할 때 연다. 목록의 출처 manifest는 시작 시 비공유조건 권리 판정을 통과하며, 아카이브의 지리 범위·출처 표기는 첫 사용 시 대조한다.

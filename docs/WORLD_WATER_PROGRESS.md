...
뉴욕시 5개 카운티 수면, [매사추세츠주 14개 카운티 수면](MA_STATE_WATER_PROGRESS.md), [뉴햄프셔주 10개 카운티 수면](NH_STATE_PROGRESS.md), [버몬트주 14개 카운티 수면](VT_STATE_PROGRESS.md), [메인주 16개 카운티 수면](ME_STATE_PROGRESS.md), [메릴랜드주 24개 카운티 상당 단위 수면](MD_STATE_PROGRESS.md), [펜실베이니아주 67개 카운티 수면](PA_STATE_PROGRESS.md), [웨스트버지니아주 55개 카운티 수면](WV_STATE_PROGRESS.md), [오하이오주 88개 카운티 수면](OH_STATE_PROGRESS.md), [버지니아주 133개 카운티 상당 단위 수면](VA_STATE_PROGRESS.md), [노스캐롤라이나주 100개 카운티 수면](NC_STATE_PROGRESS.md), [사우스캐롤라이나주 46개 카운티 수면](SC_STATE_PROGRESS.md), [테네시주 95개 카운티 수면](TN_STATE_PROGRESS.md), [켄터키주 120개 카운티 수면](KY_STATE_PROGRESS.md), [조지아주 159개 카운티 수역](GA_STATE_PROGRESS.md), [앨라배마주 67개 카운티 수역](AL_STATE_PROGRESS.md), [미시시피주 82개 카운티 수역](MS_STATE_PROGRESS.md), [루이지애나주 64개 교구 수역](LA_STATE_PROGRESS.md), [아칸소주 75개 카운티 수역](AR_STATE_PROGRESS.md), [플로리다주 67개 카운티 수역](FL_STATE_PROGRESS.md), [워싱턴 DC 수면](DC_PROGRESS.md), [프랑스 IGN 파리 D075 상세 수면](FR_PARIS_WATER_PROGRESS.md)을 기본 세계 모드에 연결했다. 나머지 세계의 상세 수면은 아직 구축하지 않았다.

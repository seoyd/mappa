...
뉴욕시 5개 카운티 수면, [매사추세츠주 14개 카운티 수면](MA_STATE_WATER_PROGRESS.md), [프랑스 IGN 파리 D075 상세 수면](FR_PARIS_WATER_PROGRESS.md)을 기본 세계 모드에 연결했다. 나머지 세계의 상세 수면은 아직 구축하지 않았다.

...
| W1 전 세계 중간 상세 | 퍼블릭 도메인 1:10m 원본을 Rust로 z5–z7 타일화; 11,021개 타일, 6,742,358 B | 6개 입력 SHA-256 확인, 11,021개 전부 해독 오류 0, 재생성 SHA 일치 | PASS_MAC_OVERVIEW |
| W2 지역 선택 | 기본 세계 모드에서 세계 110m·10m 파일만 선택; 동아시아 10m은 비교용 | 타일 선택 테스트, 동아시아·아마존·나일강 Metal PNG 오류 0 | PASS_MAC |
| W3 길·시설 | 선별된 1:10m 주요 도로·도시·개략 수계선만 전 세계 파일에 수록; 도로망 완전성·역·기관·건물 없음 | 원본 설명과 대륙별 화면 확인, 현장 정확도 미측정 | PARTIAL |

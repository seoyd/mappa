...
| W1 전 세계 중간 상세 | 퍼블릭 도메인 1:10m 원본을 Rust로 z5–z7 타일화; 11,021개 타일, 6,121,010 B | 5개 입력 SHA-256 확인, 11,021개 전부 해독 오류 0, 재빌드 해시 동일 | PASS_MAC_OVERVIEW |
| W2 지역 선택 | 동아시아 내부 기존 1:10m, 그 밖은 새 전 세계 1:10m | 타일 선택 테스트, 유럽·아프리카·남미·호주·피지 Metal PNG 오류 0 | PASS_MAC |
| W3 길·시설 | 선별된 1:10m 주요 도로·도시만 전 세계 파일에 수록; 도로망 완전성·역·기관·건물 없음 | 원본 설명과 대륙별 화면 확인, 현장 정확도 미측정 | PARTIAL |
